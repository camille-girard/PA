  ...
  <UBaseModal :is-open="isOpen" class="max-w-4xl" @close="handleClose">
    <div class="px-6 pt-6">
      ...
      <div v-if="currentImages.length > 0" class="space-y-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-200">
      ...
      <div class="space-y-4">
        ...
        <div class="relative">
          <div class="border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center hover:border-blue-400 hover:bg-blue-50/50 transition-colors duration-200">
            <UFileInput
              ref="fileInput"
              multiple
              accept="image/*"
          ...
          <div v-if="currentImages.length >= 10" class="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <p class="text-sm text-yellow-700 mt-1">Vous avez atteint la limite de 10 images par logement</p>
          </div>
        </div>
      </div>
      ...
      <div v-if="pendingImages.length > 0" class="space-y-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <!-- Badge "Nouveau" -->
            <div class="absolute top-2 left-2 bg-green-500 text-white px-2 py-1 rounded-lg text-xs font-medium shadow-lg">
              Nouveau
            </div>
