...
const containerClasses = {
    ...
    underline: { sm: 'gap-1 border-b border-secondary', md: 'gap-1 border-b border-secondary' },
    border: { sm: 'gap-1 p-1 border border-secondary bg-secondary-alt rounded-[10px]', md: 'p-1.5 gap-1' },
    minimal: { sm: 'gap-0.5 bg-secondary-alt border border-secondary rounded-lg overflow-hidden', md: '' },
};
