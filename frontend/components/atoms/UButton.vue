<script setup lang="ts">
    ...
    const baseClasses =
        'flex items-center justify-center font-semibold gap-1 rounded-lg transition focus:ring-1 focus:ring-primary ring-offset-2 focus:outline-none ring-offset-transparent [&_svg]:size-5 [&_svg]:transition-colors [&_svg]:duration-200 [&_svg]:ease-in-out text-body-md';
    ...
    const variantClasses = {
        ...
        secondary:
            'bg-primary enabled:hover:bg-primary-hover text-secondary hover:text-secondary-hover border border-primary disabled:text-fg-disabled disabled:border-disabled-subtle [&_svg]:text-fg-quaternary [&_svg]:hover:text-fg-quaternary-hover shadow-xs',
