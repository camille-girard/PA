<script setup lang="ts">
  ...
  const variantClasses = {
    primary: 'justify-center bg-brand-solid hover:bg-brand-solid-hover text-white enabled:shadow-xs-custom border border-brand enabled:bg-linear-grad disabled:border-disabled-subtle disabled:bg-disabled disabled:text-fg-disabled [&_svg]:text-button-primary-icon [&_svg]:hover:text-button-primary-icon-hover',
