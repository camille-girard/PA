<script setup lang="ts">
    ...
    const handleRatingSubmit = async (ratingData: { accommodationRating: number; accommodationComment: string; ownerRating: number }) => {
        try {
    ...
    <div class="border border-gray-200 rounded-xl p-6 flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div class="mt-4 md:mt-0 md:text-right space-y-2">
            ...
            <div class="flex flex-col md:flex-row md:justify-end gap-2">
                ...
                <UButton
                    v-if="isBookingCompleted && !booking.hasRated"
                    color="orange"
                    @click="onRate()"
                >
                ...
                <UButton
                    v-else-if="isBookingCompleted && booking.hasRated"
                    color="green"
                    disabled
                >
