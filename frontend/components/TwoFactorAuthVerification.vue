  ...
  <div class="w-full max-w-md mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
    ...
    <div class="text-center mb-6">
      ...
      <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
        <span v-if="props.email">
          Saisissez le code envoyé pour {{ props.email }}
        </span>
        <span v-else>
    ...
    <div class="space-y-4">
      ...
      <p class="text-xs text-gray-500 dark:text-gray-400 text-center">
        Le code expire dans quelques minutes. Si vous ne l'avez pas reçu, vérifiez votre application d'authentification.
      </p>
    </div>
    ...
    <div class="mt-6 text-center">
      <p class="text-xs text-gray-500 dark:text-gray-400">
        ...
        <ULink to="/contact" class="text-orange-600 hover:text-orange-700">
