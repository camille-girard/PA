    ...
    <form class="space-y-16 max-w-4xl mx-auto">
        ...
        <section>
            ...
            >
                ...
                @drop="handleDrop" class="w-full h-52 rounded-2xl bg-gray-100 flex flex-col items-center justify-center
                relative cursor-pointer hover:bg-gray-200 transition border-dashed border-2">
                <img src="/icon.svg" alt="Ajouter" class="w-10 h-10 opacity-40" />
                <p class="mt-2 text-sm text-gray-400 text-center">Cliquez ou glissez jusqu'à 10 images ici</p>
            </div>
