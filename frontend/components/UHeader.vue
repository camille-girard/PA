        ...
        <transition name="fade">
            <div v-if="isMenuOpen" class="md:hidden mt-4 px-4 space-y-4 pt-6">
                ...
                <template v-if="authStore.isAuthenticated">
                    ...
                    <ULink v-if="canViewAccommodation" to="/my-accommodation" class="block text-gray-700 font-medium">
                        Mon Hébergement
                    </ULink>

                    <ULink v-if="!canViewAccommodation" to="/owner-request" class="block text-gray-700 font-medium">
                        Devenir propriétaire
                    </ULink>
