...
<template>
    <div>
        ...
        <div v-if="open" class="fixed inset-0 z-50 flex items-center justify-center">
            <div class="absolute inset-0 bg-black bg-opacity-30 backdrop-blur-sm" @click="open = false" />
            ...
            <div class="relative z-10 bg-white dark:bg-gray-900 p-6 rounded-xl shadow-xl w-full max-w-md">
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <button class="px-3 py-1 text-sm bg-red-600 text-white rounded hover:bg-red-700" @click="confirm">
                        Supprimer
                    </button>
                </div>
            </div>
