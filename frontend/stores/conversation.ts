  ...
  actions: {
    ...
    addMessage(message: Message) {
      ...
      const conversationId = message.conversation?.id || 
                            (typeof message.conversation === 'number' ? message.conversation : null);
      ...
      if (index !== -1) {
        ...
        const hasNewMessages = !this.currentConversation || 
    ...
    normalizeMessageObject(message: Message) {
      ...
      if (!message.sender || 
          typeof message.sender === 'object' && Object.keys(message.sender).length === 0) {
        ...
        if (message.client && typeof message.client === 'object' && message.client.id && 
            message.owner && typeof message.owner === 'object' && message.owner.id) {
