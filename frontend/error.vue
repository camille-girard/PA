    ...
    <main class="relative flex justify-center pt-24 w-full h-full">
        ...
        <section class="max-w-7xl flex flex-col items-center z-10">
            ...
            <div class="space-y-6 mt-4">
                <h1 class="font-semibold text-primary text-6xl text-center">{{ title }}</h1>
                <p class="text-tertiary text-xl text-center">{{ subtitle }}</p>
            </div>
            <div class="mt-12 flex gap-3">
                <UButton :icon="ArrowLeftIcon" icon-position="leading" variant="secondary" @click="$router.back()">Go back</UButton>
