  ...
  <main class="w-full h-full">
    ...
    <div class="max-w-4xl mx-auto mt-20 px-4 py-16">
      ...
      <div class="bg-white p-8 rounded-2xl shadow-lg space-y-8">
        <div class="space-y-2">
          <label class="block text-base font-medium">Titre du ticket <span class="text-red-500">*</span></label>
          <input
              v-model="title"
              type="text"
        ...
        <div class="space-y-2">
          <label class="block text-base font-medium">Premier message <span class="text-red-500">*</span></label>
          <UTextarea
              v-model="message"
