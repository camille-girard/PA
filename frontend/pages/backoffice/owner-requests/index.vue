            ...
            <UTable :columns="columns" :data="ownerRequestsData">
                ...
                <template #cell-actions="{ row }">
                    <div class="flex items-center gap-2">
                        ...
                        <div v-else class="text-gray-500 text-sm">Traité</div>
                    </div>
                </template>
            </UTable>
        </div>
            ...
            <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <button class="text-gray-400 hover:text-gray-600 text-2xl" @click="closeDetailModal">×</button>
                    </div>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                <div>
                                    ...
                                    <span class="ml-2"
                                        >{{ selectedRequest.user.firstName }} {{ selectedRequest.user.lastName }}</span
                                    >
                                </div>
                                <div>
