        ...
        <UCard>
          <div class="space-y-4">
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <UBadge
                  :color="isOccupiedNow ? 'warning' : 'success'"
                  variant="pill"
              >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div><strong>Adresse :</strong> {{ accommodation.address }}, {{ accommodation.city ?? 'N/A' }}</div>
              ...
              <div class="sm:col-span-2"><strong>Propriétaire :</strong> {{ accommodation.host?.firstName }} {{ accommodation.host?.lastName }}</div>
            ...
            <div v-if="accommodation.practicalInformations" class="pt-2 border-t">
              ...
              <p class="text-gray-700 mt-1 whitespace-pre-wrap">{{ accommodation.practicalInformations }}</p>
            </div>
            ...
            <div class="pt-2 border-t">
              ...
              <p class="text-gray-700 mt-1">
                Latitude : {{ accommodation.latitude ?? 'N/A' }}, Longitude : {{ accommodation.longitude ?? 'N/A' }}
              </p>
            </div>
            ...
            <div v-if="bookings.length">
              <UTable :columns="columns" :data="bookings">
                <template #cell-status="{ value }">
                  <UBadge size="sm" variant="pill" class="text-center" :color="getStatusProps(value).color">
