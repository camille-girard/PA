...
<template>
  <main class="w-full h-full">
    ...
    <div class="max-w-7xl w-full mx-auto pt-8 px-4">
      ...
      <p v-else-if="!filteredBookings.length" class="text-center text-gray-500">
      ...
      <div v-else class="space-y-6">
        <BookingItem
            ...
            @delete="() => { selectedBookingId = booking.id; showDeleteModal = true }"
    ...
    >
      <div class="bg-white p-6 rounded-xl shadow-lg max-w-sm text-center space-y-4">
        ...
        <div class="flex justify-center gap-4 mt-4">
          ...
          <UButton size="md" variant="destructive" @click="deleteBooking">
            Confirmer
          </UButton>
        </div>
      </div>
