        ...
        try {
            ...
            if (res?.id) {
                const stripe = await loadStripe(
                    'pk_test_51PVKMCKnwz4ouw1LKDOGFG9UlGQPb6VzbQBgM4czJs41hmYl5s5aHdqkuoS5RrB5cxS2MYXAmQRlO79Fg5zW2dMx00YzNqpxig'
                );
                ...
                <div class="max-w-xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-8 border border-gray-200">
                    <div class="space-y-2 text-center">
                        ...
                        <div class="text-md text-gray-700">
                            <p>
                                Du <span class="font-semibold text-gray-900">{{ formattedArrival }}</span> au
                                <span class="font-semibold text-gray-900">{{ formattedDeparture }}</span>
                            </p>
                    ...
                    <div class="border-t pt-6 space-y-4">
                        ...
                        <ul class="text-gray-800 space-y-2">
                            <li class="flex justify-between">
                                <span
                                    >{{ pricePerNight.toFixed(2) }} € × {{ nights }} nuit{{
                                        nights > 1 ? 's' : ''
                                    }}</span
                                >
                    ...
                    <div class="pt-6 flex justify-center">
                        <UButton size="lg" variant="primary" :disabled="isLoading || !clientId" @click="createCheckout">
